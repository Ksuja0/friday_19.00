...
font.init()
font1 = font.SysFont('monospaced', 38)
...
coin1 = Coins('dollar-coin2.png', 580, 70, 20, 20)
coin2 = Coins('dollar-coin2.png', 250, 130, 20, 20)
coin3 = Coins('dollar-coin2.png', 50, 450, 20, 20)
coin4 = Coins('dollar-coin2.png', 450, 120, 20, 20)
coin5 = Coins('dollar-coin2.png', 320, 450, 20, 20)
...
mixer.init()
mixer.music.load('Italian music.mp3.mp3')
mixer.music.play()
...
while run:
    ...
    if not Finish:
        ...
        coin = font1.render(f'Score : {coins_amount} / 5', True, (0, 0, 0))
        ...
        if sprite.spritecollide(mypizza, coinss, True):
            coins_amount += 1
